...
def load_data(Battary_list, dir_path):
    ...
    for name in Battary_list:
        ...
        CCCT = np.array(CCCT)
        CVCT = np.array(CVCT)
        # Assume drop_outlier returns an index array
...
load_data(Battary_list=['CS2_35', 'CS2_36', 'CS2_37', 'CS2_38'], dir_path=r"C:\Users\hsx\Desktop\machine learning-literature\数据库原件\calse\CS2_35_1_10_11.xlsx")