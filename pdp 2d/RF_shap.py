...
def rf_evaluate(max_depth, n_estimators, min_samples_split, max_features):
    params = {
...
print(f"RandomForest - RMSE: {rmse:.4f}, MAE: {mae:.4f}, R²: {r2:.4f}, Training Time: {training_time:.2f}s")


# PDP and ICE plotting function
def plot_pdp_ice(model, model_name, X_train_scaled):
    feature_pairs = [('CVCT', 'Qdlin'), ('CVCT', 'Temp_m'), ('CVCT', 'ir')]
    selected_features = ['CVCT', 'Qdlin', 'Temp_m', 'ir']
...
plot_pdp_ice(rf_model, "RandomForest", X_train_scaled)
